...
PYBIND11_MODULE(utils, m) {
    ...
    // gimdict + the mapping-toolkit family (gimmap, frozen_gimmap) — the
    // implementation lives in mapping/adapter.h over the toolkit core.
    pygim::mapping::register_mapping(m);
