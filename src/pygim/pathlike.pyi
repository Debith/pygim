...
class arrow_column:
    """A PathSet column in Arrow layout, exported through the Arrow PyCapsule protocol
    without copying: pass it to pyarrow.array(), polars.from_arrow(), ..."""
...
class PathSet:
    ...
    Filters and |, &, - return sets sharing the table. paths()/names() are Arrow columns;
    from_arrow() reads any Arrow-protocol object (pyarrow, polars, ...)."""
    ...
    def paths(self) -> arrow_column: ...
    def names(self) -> arrow_column: ...
    def to_list(self) -> list[str]: ...
    def stats(self) -> dict[str, int]: ...
    @staticmethod
    def from_arrow(column: object) -> PathSet: ...
