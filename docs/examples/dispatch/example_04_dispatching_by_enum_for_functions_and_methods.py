...
# Define a dispatch function, dispatch_by_type, to handle multiple types of inputs
...
class ClassDispatchExample:
    # Define a method dispatch_by_type inside the class and decorate it with @dispatch
    @dispatch
